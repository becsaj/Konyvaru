namespace Konyvaru.Migrations
{
    ...
    public partial class Create : DbMigration
    {
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Megnevezes = c.String(),
                        Nepszeruseg = c.Double(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Konyvs", "KategoriaId", "dbo.Kategorias");
            ...
            DropIndex("dbo.Konyvs", new[] { "KategoriaId" });
            DropTable("dbo.AspNetUserLogins");
            DropTable("dbo.AspNetUserClaims");
            DropTable("dbo.AspNetUsers");
            DropTable("dbo.AspNetUserRoles");
            DropTable("dbo.AspNetRoles");
            DropTable("dbo.Poszts");
            DropTable("dbo.Kategorias");
            DropTable("dbo.Konyvs");
        }
    }
}
